...
status: todo
stories: [MC-008, MC-009, MC-010, MC-011, MC-012, MC-013]
---
...
4. MC-011 - A batch runs every file and reports a run summary
5. MC-012 - Command-line file paths run headlessly for Send to
6. MC-013 - The output folder is remembered between runs
